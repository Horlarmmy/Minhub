...
export interface MinHubInterface extends utils.Interface {
  functions: {
    ...
    "setRoyalty(address,uint256)": FunctionFragment;
...
export interface MinHub extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MinHubInterface;
